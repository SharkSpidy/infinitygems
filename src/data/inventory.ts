...
export const initialInventory: Ore[] = [
  {
    id: 'IGM-001',
    title: 'Natural Unpolished Star Sapphire',
    gemType: 'Sapphire',
    category: 'Signature',
    price: 285000,
    stock: 1,
    ...
    description: 'A natural unpolished Star Sapphire of approximately 2.3 kilograms (11,500 carats), positioned as an exceptionally rare collector and exhibition asset with museum-grade potential.',
    imageUrl: createGemImage('Natural Unpolished Star Sapphire', 'Sapphire'),
